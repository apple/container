...
`container` relies on the new features and enhancements present in the macOS 16 Beta 1. You can run the tool on macOS 15, but the `container` maintainers typically will not address issues discovered on macOS 15 that cannot be reproduced on the macOS 16 Beta 1.
