...
class TestCLIPruneCommand: CLITest {
    ...
    @Test func testContainerPruneNoContainers() throws {
        ...
        #expect(output.contains("No containers to prune"), "should show no containers message")
    }
    ...
    @Test func testContainerPruneStoppedContainers() throws {
        ...
        #expect(lines.count >= 5, "should have at least 5 lines included header, 2 lines, 1 empty line and 1 line space reclaimed")
        #expect(output.contains("Pruned containers"), "should remove the stopped containers and show no space reclaimed or no containers message")
