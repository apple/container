...
extension Application {
    public struct LoginLaunchEnable: AsyncLoggableCommand {
        public static let configuration = CommandConfiguration(
            commandName: "enable",
            abstract: "Enable the container to launch on user login"
        )
        ...
        public func run() async throws {
            let logger = Logger(label: "LoginLaunchEnable", factory: { _ in StderrLogHandler() })
